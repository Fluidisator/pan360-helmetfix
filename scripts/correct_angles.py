...
def main():
    ...
    parser.add_argument('--pitch_ref', type=str, choices=["x", "y", "z"], default="x", help="Pitch reference")
    parser.add_argument('--roll_ref', type=str, choices=["x", "y", "z"], default="y", help="Roll reference")
    parser.add_argument('--yaw_ref', type=str, choices=["x", "y", "z"], default="z", help="Yaw reference")
